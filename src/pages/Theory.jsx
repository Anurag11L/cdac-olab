...
const Theory = () => {
  ...
  return (
    ...
    <br></br>
        ...
        <div style={{ fontSize: '5vh', fontWeight: 'bold' ,textAlign:'left',marginLeft:'0px',width:'100%',textShadow:' 2px 2px 50px #000000'}}>
            Introduction
        </div>
        <br></br>
        <br></br>
        ...
        <div style={{ fontSize: '', fontWeight: '' ,textAlign:'left',marginLeft:'0px',width:'100%',textShadow:' 2px 2px 50px #000000'}} >The spiral of Theodorus, also known as the square root spiral, Spiral of Einstein, Pythagorean spiral, or Pythagoras's snail, is a unique geometric construction. It consists of a sequence of right triangles arranged in a spiral formation, with each triangle sharing one side with the previous one. This captivating spiral is attributed to its namesake, Theodorus of Cyrene.
        </div>
        <br></br>


        <p style={{ fontSize: '5vh', fontWeight: 'bold' ,textAlign:'left',marginLeft:'0px',width:'100%',textShadow:' 2px 2px 50px #000000'}}>Construction</p>
