...
const Theory = () => {
  ...
  return (
    ...
    <br></br>
        ...
        <div style={{ fontSize: '', fontWeight: '' ,textAlign:'left',marginLeft:'0px',width:'100%'}} >In geometry, the spiral of Theodorus also called square root spiral, Spiral of Einstein, Pythagorean spiral, or Pythagoras's snail is a spiral composed of right triangles, placed edge-to-edge. It was named after Theodorus of Cyrene.
        </div>
        <br></br>
        ...
        <div style={{ fontSize: '', fontWeight: '' ,textAlign:'left',marginLeft:'0px',width:'100%'}}>The spiral is started with an isosceles right triangle, with each leg having unit length. Another right triangle is formed, an automedian right triangle with one leg being the hypotenuse of the prior triangle (with length the square root of 2) and the other leg having length of 1; the length of the hypotenuse of this second triangle is the square root of 3. The process then repeats; the nth triangle in the sequence is a right triangle with the side lengths √ n and 1, and with hypotenuse √n+1. For example, the 16th triangle has sides measuring 4=√16 , 1 and hypotenuse of √17.
        </div>
        <br></br>
