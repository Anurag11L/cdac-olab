...
const Home = () => {
  ...
  return (
    ...
    <br></br>
        ...
        <div style={{ fontSize: '5vh', fontWeight: 'bold' ,textAlign:'left',marginLeft:'0px',width:'100%',textShadow:' 2px 2px 20px #000000'}}>
            Introduction
        </div>
        <br></br>
        <br></br>
